> Historical design notes, archived on 2026-08-26. This is not current guidance or
> verification evidence. Old examples, design values, release labels, checkboxes,
> and quality claims have not been revalidated against the current application.
